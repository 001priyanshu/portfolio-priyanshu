...
import logo from '../images/priyanshuDp.jpg';
  ...
  return (
    <nav className="py-4 md:py-6">
      <div className="font-Poppins container px-4 mx-auto md:flex md:items-center">
        <div className="flex justify-between items-center w-full rounded-full">
          <a href="/" className="font-bold text-xl text-indigo-600 bg-white h-12 w-12 sm:h-20 sm:w-20 rounded-full overflow-hidden">
            <Image
              src={logo}
              height={75}
              width={75}
